# -*- coding: utf-8 -*-
"""
Created on Sun Apr 16 20:17:53 2017
...
#	print (estimate_pro)
	...
	#getROCCurve(testLabel, classificationResult)
...
#def getROCCurve(testLabel, classificationResult):
#	print (classification_report(testLabel,classificationResult,target_names=None))
#	print ('====================================get ROC ====================')
#	#交叉验证
#	mean_tpr = 0.0
